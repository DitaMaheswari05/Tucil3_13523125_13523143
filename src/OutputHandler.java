...
public class OutputHandler {
    ...
    /**
     * Prints the board state with colored output for the primary piece, exit door, and moved piece
     * @param papan the board to print
     */
    private void printBoard(Papan papan) {
        // ANSI color codes
